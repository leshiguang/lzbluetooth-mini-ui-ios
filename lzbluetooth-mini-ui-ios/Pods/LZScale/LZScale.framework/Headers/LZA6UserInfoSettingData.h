...
typedef NS_ENUM(UInt8, LZA6UserInfoGender) {
    LZA6UserInfoGenderMale,
    LZA6UserInfoGenderFeMale,
};

@interface LZA6UserInfoSettingData : LZA6Data

/// 0：客人/未识别用户 1~4：已识别用户 255：无效用户
@property (nonatomic, assign) UInt8 userNumber;

/// 0：男性 1：女性
@property (nonatomic, assign) LZA6UserInfoGender gender;
